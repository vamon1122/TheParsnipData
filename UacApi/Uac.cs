    ...
    public static class Uac
    {
        ...
        public static void NewSecurePage(string pSecurePageUrl, Page pSecurePage, string pDeviceType, User myUser)
        {
            ...
            if (string.IsNullOrEmpty(pDeviceType) || string.IsNullOrWhiteSpace(pDeviceType))
            {
                ...
                pSecurePage.Response.Redirect("get_device_info?url=" + pSecurePageUrl);
            }
            else
            {
                ...
                if (myUser.AccountStatus == "active")
                {
                    ...
                    else
                    {
                        if (!pSecurePage.IsPostBack)
                        {
                            ...
                            pSecurePage.Response.Redirect(String.Format("access-denied?url={0}", pSecurePageUrl));
                        }
                        else
                        {
            ...
            else
            {
                ...
                pSecurePage.Response.Redirect("login");
            }
